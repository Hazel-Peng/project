...
<p>
<marquee direction="right" behavior="alternate" scrollamount="7" height="80" style="color:blue;font-size:xx-large ;font-weight:bold">吃飯不用等訂位網</marquee>
    ...
    <table>
        <tr>
            <td id="my_div">
                <img src="rest/rest1_1.png" alt="rest1_1" style="width: 100%;height:400px;">
            </td>

            <td id="my_div1">
                <img src="rest/rest2_1.jpg" alt="rest2_1" style="width: 100%;height:400px;">
            </td>

            <td id="my_div2">
                <img src="rest/rest3_1.jpg" alt="test2" style="width: 100%;height:400px;">
            </td>
        </tr>
    </table>
    ...
    <script type="text/javascript">
        ...
        function sequentialImg(){  
            document.getElementById("my_div").innerHTML  = "<img src='"+jsImg[a]+"' width=100% height=400>";       
                a++;
                if(a>=jsImg_len)  a=0;
        }
        ...
        function sequentialImg1(){  
            document.getElementById("my_div1").innerHTML  = "<img src='"+jsImg1[b]+"' width=100% height=400>";       
                b++;
                if(b>=jsImg1_len)  b=0;
        }
        ...
        function sequentialImg2(){  
            document.getElementById("my_div2").innerHTML  = "<img src='"+jsImg2[c]+"' width=100% height=400>";       
                c++;
                if(c>=jsImg2_len)  c=0;
        }
        </script>
